...
" hi CursorLine ctermfg=White ctermbg=0 cterm=NONE guifg=NONE guibg=#252f38 gui=NONE
hi CursorLine cterm=NONE gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=17 cterm=NONE guifg=NONE guibg=#252f38 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=232 cterm=NONE guifg=NONE guibg=#dfdf00 gui=NONE
hi LineNr ctermfg=0 ctermbg=NONE cterm=NONE guifg=#475967 guibg=#252f38 gui=NONE
...
hi VertSplit ctermfg=59 ctermbg=NONE cterm=NONE guifg=#35434e guibg=NONE gui=NONE
...
hi Pmenu ctermfg=253 ctermbg=232 guibg=Magenta
" hi PmenuSel ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#2d3741 gui=NONE
hi PmenuSel ctermfg=178 ctermbg=0 guibg=DarkGrey
...
hi Error ctermfg=124 ctermbg=NONE guifg=#af0000 guibg=NONE cterm=NONE
hi todo ctermfg=124 ctermbg=NONE guifg=#af0000 guibg=NONE cterm=NONE
hi Warning ctermfg=166 ctermbg=NONE guifg=#af0000 guibg=NONE cterm=NONE
hi warning ctermfg=166 ctermbg=NONE guifg=#af0000 guibg=NONE cterm=NONE

" hi SpellBad ctermfg=124 ctermbg=NONE guifg=#df8700 guibg=NONE cterm=NONE
" hi SpellCap ctermfg=124 ctermbg=NONE guifg=#df8700 guibg=NONE cterm=NONE

hi Normal ctermfg=67 ctermbg=NONE cterm=NONE guifg=#718ca1 guibg=#1d252c gui=NONE
...
hi ErrorMsg ctermfg=253 ctermbg=88 cterm=NONE guifg=#febac5 guibg=#d95468 gui=NONE
" hi WarningMsg ctermfg=218 ctermbg=167 cterm=NONE guifg=#febac5 guibg=#d95468 gui=NONE
hi WarningMsg ctermfg=184 cterm=NONE guifg=#dfdf00 gui=NONE
...
hi Todo ctermfg=59 ctermbg=NONE cterm=bold guifg=#41505e guibg=NONE gui=bold
